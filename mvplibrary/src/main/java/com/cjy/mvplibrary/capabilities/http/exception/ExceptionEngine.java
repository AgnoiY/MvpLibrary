package com.cjy.mvplibrary.capabilities.http.exception;
...
public class ExceptionEngine {
    ...
    public static ApiException handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {             //HTTP错误
            ...
            ex = new ApiException(e, httpExc.code(), AppLibrary.getAppString(R.string.network_error));//均视为网络错误
            return ex;
            ...
            ex = new ApiException(e, ANALYTIC_SERVER_DATA_ERROR, AppLibrary.getAppString(R.string.data_parsing_error));
            return ex;
        } else if (e instanceof ConnectException || e instanceof SSLHandshakeException || e instanceof UnknownHostException) {//连接网络错误
            ex = new ApiException(e, CONNECT_ERROR, AppLibrary.getAppString(R.string.connect_error));
            return ex;
        } else if (e instanceof SocketTimeoutException) {//网络超时
            ex = new ApiException(e, TIME_OUT_ERROR, AppLibrary.getAppString(R.string.time_out_error));
            return ex;
        } else {  //未知错误
            ex = new ApiException(e, UN_KNOWN_ERROR, AppLibrary.getAppString(R.string.un_known_error));
            return ex;
        }
    }
