...
import static com.cjy.mvplibrary.constant.Constants.LOG_E;
import static com.cjy.mvplibrary.constant.Constants.LOG_I;
...
public abstract class BaseLoadActivity<T, B extends ViewDataBinding>
    ...
    public void onError(String action, int code, String msg) {
        ...
        if (code == ExceptionEngine.CONNECT_ERROR) {//网络连接失败
            ...
            mBaseBinding.contentView.setShowImage(R.mipmap.tips_icon_notify_info);
        }
    }
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.fllayout_right) {
